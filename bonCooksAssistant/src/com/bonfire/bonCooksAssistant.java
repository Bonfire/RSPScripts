...
public class bonCooksAssistant extends TaskScript {
    ...
    private static final Task[] TASKS = {new WalkToKitchen(), new StartQuest(), new CollectStarterItems(), new WalkToCowPen(), new MilkCow(), new WalkToChickens(), new CollectEgg()};
